...
export class HomeView {
    ...
    render(): HTMLElement {
        ...
        element.innerHTML = `
            ...
            <header class="h-20 border border-[color:var(--accent)] py-7 px-0 fixed flex items-center w-[100%] z-[100] bg-[rgba(13, 17, 23, 0.95)] backdrop-blur-md shadow-md">
                <div class="container">
                    <nav class="flex justify-between items-center">
                        <a href="" class="text-3xl font-extrabold tracking-widest text-[color:var(--text)] no-underline">PINGPONG</a>
                        <div class="flex gap-8">
                            <a class="text-[color:var(--text)] no-underline font-medium transition-colors duration-300 hover:[color:var(--accent)]" href="">Home</a>
                            <a class="text-[color:var(--text)] no-underline font-medium transition-colors duration-300 hover:[color:var(--accent)]" href="">Features</a>
                            <a class="text-[color:var(--text)] no-underline font-medium transition-colors duration-300 hover:[color:var(--accent)]" href="">Tournament</a>
                        </div>
                        <div class="flex gap-8 items-center">
                            <button class="btn btn-outline bg-[bg:var(--accent)] p-2.5
